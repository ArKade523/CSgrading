...
define('vs/editor/editor.main.nls.zh-tw', {
    ...
    'vs/editor/browser/widget/diffEditor/diffEditorDecorations': ['還原選取的變更', '還原變更'],
    'vs/editor/browser/widget/diffEditor/diffEditorEditors': [' 使用 {0} 以開啟協助工具說明。'],
    ...
    'vs/editor/browser/widget/multiDiffEditorWidget/colors': ['Diff 編輯器標頭的背景色彩'],
