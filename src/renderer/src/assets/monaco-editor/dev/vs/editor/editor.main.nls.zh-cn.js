...
define('vs/editor/editor.main.nls.zh-cn', {
    ...
    'vs/editor/browser/widget/diffEditor/diffEditorDecorations': ['还原所选更改', '还原更改'],
    'vs/editor/browser/widget/diffEditor/diffEditorEditors': [' 使用 {0} 打开辅助功能帮助。'],
    ...
    'vs/editor/browser/widget/multiDiffEditorWidget/colors': ['差异编辑器标题的背景色'],
