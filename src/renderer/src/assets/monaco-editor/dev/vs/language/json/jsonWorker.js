    ...
    var moduleExports = (() => {
        ...
        ;(function (Is2) {
            ...
            function uinteger2(value) {
                return (
                    toString.call(value) === '[object Number]' && 0 <= value && value <= 2147483647
                )
            }
                ...
                function normalizeFloats(float) {
                    ...
                    return (
                        parts && {
                            ...
                            multiplier:
                                (((_a = parts[2]) === null || _a === void 0 ? void 0 : _a.length) ||
                                    0) - (parseInt(parts[3]) || 0)
                        }
                    )
                }
        ...
        function parse3(textDocument, config) {
            ...
            function _errorAtRange(message, code, startOffset, endOffset, severity) {
                ...
                if (problems.length === 0 || startOffset !== lastProblemOffset) {
                    ...
                    problems.push(
                        Diagnostic.create(range, message, severity, code, textDocument.languageId)
                    )
                ...
                case 9:
                    return {
                        ...
                        blue:
                            ...
                            255,
                        alpha:
                            (hexDigit(text.charCodeAt(7)) * 16 + hexDigit(text.charCodeAt(8))) / 255
                    }
            }
            return void 0
        }
        ...
        for (schemaName in schemaContributions.schemas) {
            ...
            for (property in schema.properties) {
                ...
                if (description) {
                    ...
                    console.log(
                        ''.concat(property, ": localize('schema.json.").concat(property, `', "")`)
                    )
                }
            }
        }
        ...
        var JSONSchemaService = (function () {
            ...
            JSONSchemaService2.prototype.getSchemaFromProperty = function (resource, document) {
                var _a, _b
                if (
                    ((_a = document.root) === null || _a === void 0 ? void 0 : _a.type) === 'object'
                ) {
                    for (var _i = 0, _c = document.root.properties; _i < _c.length; _i++) {
                        var p = _c[_i]
                        if (
                            p.keyNode.value === '$schema' &&
                            ((_b = p.valueNode) === null || _b === void 0 ? void 0 : _b.type) ===
                                'string'
                        ) {
