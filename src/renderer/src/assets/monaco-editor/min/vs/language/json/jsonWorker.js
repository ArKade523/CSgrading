...
`.indexOf(t.charAt(r)) !== -1
        ...
        ;(function (t) {
            ...
            function i(e) {
                var n = e
                return (
                    x.defined(n) && x.string(n.uri) && (n.version === null || x.integer(n.version))
                )
            }
            t.is = i
        })(Qe || (Qe = {}))
        ...
        ;(function (t) {
            ...
            function i(e) {
                var n = e
                return (
                    x.string(n) || (x.objectLiteral(n) && x.string(n.language) && x.string(n.value))
                )
            }
            t.is = i
        })(Ue || (Ue = {}))
        ...
        ;(function (t) {
            ...
            function i(e) {
                var n = e
                return (
                    x.defined(n) && U.is(n.range) && (x.undefined(n.target) || x.string(n.target))
                )
            }
            t.is = i
        })(Lt || (Lt = {}))
            ...
            return (
                j !== 17 &&
                    ...
                    E
                        ...
                        : u(
                              M('Invalid symbol', 'Expected a JSON object, array or literal.'),
                              W.Undefined
                          )),
                new kr(E, i, s)
            )
                                ...
                                if (d.node === e && !d.inverted && d.schema) {
                                    ...
                                    if (l !== void 0) {
                                        ...
                                        if (d.schema.patternProperties && !y)
                                            for (
                                                var O = 0,
                                                    E = Object.keys(d.schema.patternProperties);
                                                O < E.length;
                                                O++
                                            ) {
                                                var j = E[O],
                        ...
                        var s = {
                            ...
                            relative: function (o, f) {
                                ...
                                for (
                                    ...
                                    if (d === m) {
                                        if (g > m) {
                                            if (f.charCodeAt(h + d) === 47)
                                                return f.slice(h + d + 1)
                            ...
                            O = (function (T) {
                                ...
                                return (
                                    ...
                                    (S.prototype.toJSON = function () {
                                        ...
                                        return (
                                            this._fsPath &&
                                                ((k.fsPath = this._fsPath), (k._sep = v)),
                    ...
                    if (((e = i.root) === null || e === void 0 ? void 0 : e.type) === 'object')
                        for (var a = 0, s = i.root.properties; a < s.length; a++) {
                            ...
                            if (
                                ...
                                ((n = o.valueNode) === null || n === void 0 ? void 0 : n.type) ===
                                    'string'
                            ) {
