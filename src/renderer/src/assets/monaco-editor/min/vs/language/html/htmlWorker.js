    ...
    var moduleExports = (() => {
        ...
        ;(function (t) {
            ...
            function o(n) {
                var e = n
                return (
                    _.defined(e) && _.string(e.uri) && (e.version === null || _.integer(e.version))
                )
            }
            t.is = o
        })(Pe || (Pe = {}))
        ...
        ;(function (t) {
            ...
            function o(n) {
                var e = n
                return (
                    _.string(e) || (_.objectLiteral(e) && _.string(e.language) && _.string(e.value))
                )
            }
            t.is = o
        })(Le || (Le = {}))
        ...
        ;(function (t) {
            ...
            function o(n) {
                var e = n
                return (
                    _.defined(e) && P.is(e.range) && (_.undefined(e.target) || _.string(e.target))
                )
            }
            t.is = o
        })(ut || (ut = {}))
            ...
            Un = (function () {
                ...
                return (
                    ...
                    (t.prototype.peekChar = function (i) {
                        return (
                            i === void 0 && (i = 0), this.source.charCodeAt(this.position + i) || 0
                        )
                    }),
                            ...
                            (r.prototype.__split = function (s, u) {
                                ...
                                for (var h = 0, d = [], g = s.exec(u); g; )
                                    d.push(u.substring(h, g.index)),
                                        ...
                                        (g = s.exec(u))
                                return (
                                    h < u.length ? d.push(u.substring(h, u.length)) : d.push(''), d
                                )
                            }),
...
`.indexOf(t.charAt(i)) !== -1
                            ...
                            B = (function (T) {
                                ...
                                return (
                                    ...
                                    (v.prototype.toJSON = function () {
                                        ...
                                        return (
                                            this._fsPath &&
                                                ((k.fsPath = this._fsPath), (k._sep = M)),
        ...
        function yi(t, i, o, n) {
            if (!(/^\s*javascript\:/i.test(i) || /[\n\r]/.test(i))) {
                if (
                    ((i = i.replace(/^\s*/g, '')), /^https?:\/\//i.test(i) || /^file:\/\//i.test(i))
                )
                    return i
