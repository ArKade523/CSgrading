...
class FindWidget extends Disposable {
    ...
    constructor(container, tree, contextViewProvider, mode, matchType, options) {
        ...
        this.modeToggle = this._register(
            new ModeToggle({ ...styles.toggleStyles, isChecked: mode === TreeFindMode.Filter })
        )
...
class FindController {
    ...
    render() {
        ...
        if (this.pattern && noMatches) {
            if (
                (_a = this.tree.options.showNotFoundMessage) !== null && _a !== void 0 ? _a : true
            ) {
...
class StickyScrollController extends Disposable {
    ...
    findStickyState(firstVisibleNode) {
        ...
        while (
            nextStickyNode &&
            stickyNodesHeight + nextStickyNode.height < maximumStickyWidgetHeight
        ) {
...
function asTreeMouseEvent(event) {
    ...
    if (hasParentWithClass(event.browserEvent.target, 'monaco-tl-twistie', 'monaco-tl-row')) {
        ...
        hasParentWithClass(event.browserEvent.target, 'monaco-tl-contents', 'monaco-tl-row')
    ) {
...
export class AbstractTree {
    ...
    get findMatchType() {
        var _a, _b
        return (_b =
            (_a = this.findController) === null || _a === void 0 ? void 0 : _a.matchType) !==
            null && _b !== void 0
            ? _b
            : TreeFindMatchType.Fuzzy
    }
    ...
    constructor(_user, container, delegate, renderers, _options = {}) {
        ...
        if (_options.keyboardSupport !== false) {
            const onKeyDown = Event.chain(this.view.onKeyDown, ($) =>
                $.filter((e) => !isInputElement(e.target)).map((e) => new StandardKeyboardEvent(e))
            )
            ...
            Event.chain(onKeyDown, ($) => $.filter((e) => e.keyCode === 10 /* KeyCode.Space */))(
                this.onSpace,
                this,
                this.disposables
            )
