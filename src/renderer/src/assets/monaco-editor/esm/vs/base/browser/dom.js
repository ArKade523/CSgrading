...
export const {
    ...
    return {
        ...
        getWindow(e) {
            ...
            if (
                candidateEvent === null || candidateEvent === void 0 ? void 0 : candidateEvent.view
            ) {
...
;(function () {
    ...
    const animationFrameRunner = (targetWindowId) => {
        ...
        const currentQueue =
            (_a = NEXT_QUEUE.get(targetWindowId)) !== null && _a !== void 0 ? _a : []
...
export function getClientArea(element, fallback) {
    ...
    if (
        platform.isIOS &&
        (elWindow === null || elWindow === void 0 ? void 0 : elWindow.visualViewport)
    ) {
        return new Dimension(elWindow.visualViewport.width, elWindow.visualViewport.height)
    }
    // Try innerWidth / innerHeight
    if (
        (elWindow === null || elWindow === void 0 ? void 0 : elWindow.innerWidth) &&
...
export function isAncestor(testChild, testAncestor) {
    return Boolean(
        testAncestor === null || testAncestor === void 0 ? void 0 : testAncestor.contains(testChild)
    )
}
...
export function getShadowRoot(domNode) {
    ...
    while (domNode.parentNode) {
        if (
            domNode === ((_a = domNode.ownerDocument) === null || _a === void 0 ? void 0 : _a.body)
        ) {
            // reached the body
            return null
        }
...
export function getActiveWindow() {
    ...
    return (_b = (_a = document.defaultView) === null || _a === void 0 ? void 0 : _a.window) !==
        null && _b !== void 0
        ? _b
        : mainWindow
}
...
function cloneGlobalStyleSheet(globalStylesheet, globalStylesheetClones, targetWindow) {
    ...
    for (const rule of getDynamicStyleSheetRules(globalStylesheet)) {
        ;(_a = clone.sheet) === null || _a === void 0
            ...
            : _a.insertRule(
                  rule.cssText,
                  (_b = clone.sheet) === null || _b === void 0 ? void 0 : _b.cssRules.length
              )
    }
    disposables.add(
            ...
            disposables.add(
                toDisposable(() => {
                    ...
                    if (resolvedMutationObserverPerOptions.users === 0) {
                        onDidMutate.dispose()
                        observer.disconnect()
                        mutationObserversPerTarget === null || mutationObserversPerTarget === void 0
                            ? void 0
...
export function createCSSRule(selector, cssText, style = getSharedStyleSheet()) {
    ...
    for (const clonedGlobalStylesheet of (_b = globalStylesheets.get(style)) !== null &&
    _b !== void 0
        ? _b
        : []) {
    ...
    registerListeners() {
        if (this.callbacks.onDragStart) {
            this._register(
                addDisposableListener(this.element, EventType.DRAG_START, (e) => {
                    var _a, _b
                    ;(_b = (_a = this.callbacks).onDragStart) === null || _b === void 0
                        ? void 0
                        : _b.call(_a, e)
                })
            )
        ...
        if (this.callbacks.onDrag) {
            this._register(
                addDisposableListener(this.element, EventType.DRAG, (e) => {
                    var _a, _b
                    ;(_b = (_a = this.callbacks).onDrag) === null || _b === void 0
                        ? void 0
                        : _b.call(_a, e)
                })
            )
        ...
        this._register(
            addDisposableListener(this.element, EventType.DRAG_ENTER, (e) => {
                ...
                ;(_b = (_a = this.callbacks).onDragEnter) === null || _b === void 0
                    ? void 0
                    : _b.call(_a, e)
            })
        )
        ...
        this._register(
            addDisposableListener(this.element, EventType.DRAG_LEAVE, (e) => {
                ...
                if (this.counter === 0) {
                    this.dragStartTime = 0
                    ;(_b = (_a = this.callbacks).onDragLeave) === null || _b === void 0
                        ? void 0
                        : _b.call(_a, e)
                }
            })
