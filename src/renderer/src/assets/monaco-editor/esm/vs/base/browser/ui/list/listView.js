...
export class ListView {
    ...
    constructor(container, virtualDelegate, renderers, options = DefaultOptions) {
        ...
        this.scrollable = this.disposables.add(
            new Scrollable({
                ...
                smoothScrollDuration: (
                    (_d = options.smoothScrolling) !== null && _d !== void 0 ? _d : false
                )
                    ? 125
                    : 0,
            ...
            new SmoothScrollableElement(
                this.rowsContainer,
                {
                    alwaysConsumeMouseWheel:
                        (_e = options.alwaysConsumeMouseWheel) !== null && _e !== void 0
                            ? _e
                            : DefaultOptions.alwaysConsumeMouseWheel,
                    horizontal: 1 /* ScrollbarVisibility.Auto */,
                    vertical:
                        (_f = options.verticalScrollMode) !== null && _f !== void 0
                            ? _f
        ...
        this.setRowHeight =
            (_j = options.setRowHeight) !== null && _j !== void 0 ? _j : DefaultOptions.setRowHeight
        ...
        this.layout(
            (_m = options.initialSize) === null || _m === void 0 ? void 0 : _m.height,
            (_o = options.initialSize) === null || _o === void 0 ? void 0 : _o.width
        )
    }
            ...
            if (!didChange) {
                ...
                for (const range of renderRanges) {
                    for (let i = range.start; i < range.end; i++) {
                        ...
                        const beforeRow =
                            afterIndex < this.items.length ? this.items[afterIndex].row : null
