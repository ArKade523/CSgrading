...
export class Emitter {
    ...
    dispose() {
        ...
        if (!this._disposed) {
            ...
            if (
                ((_a = this._deliveryQueue) === null || _a === void 0 ? void 0 : _a.current) ===
                this
            ) {
    ...
    get event() {
        ...
        ;(_a = this._event) !== null && _a !== void 0
            ...
            : (this._event = (callback, thisArgs, disposables) => {
                  ...
                  if (_enableDisposeWithListenerWarning) {
                      contained.stack =
                          stack !== null && stack !== void 0 ? stack : Stacktrace.create()
                  }
                  if (!this._listeners) {
                      ;(_b =
                          (_a = this._options) === null || _a === void 0
                              ? void 0
                              : _a.onWillAddFirstListener) === null || _b === void 0
                          ? void 0
                          : _b.call(_a, this)
                      ...
                      ;(_d =
                          (_c = this._options) === null || _c === void 0
                              ? void 0
                              : _c.onDidAddFirstListener) === null || _d === void 0
                          ? void 0
                          : _d.call(_c, this)
