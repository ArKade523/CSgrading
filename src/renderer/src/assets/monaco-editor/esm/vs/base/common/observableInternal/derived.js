...
export function derivedOpts(options, computeFn) {
    ...
    return new Derived(
        ...
        undefined,
        undefined,
        (_a = options.equalityComparer) !== null && _a !== void 0 ? _a : defaultEqualityComparer
    )
}
/**
...
export class Derived extends BaseObservable {
    get debugName() {
        var _a
        return (_a = getDebugName(this, this._debugName, this._computeFn, this._owner, this)) !==
            null && _a !== void 0
            ? _a
            : '(anonymous)'
    }
    constructor(
        ...
        this.changeSummary =
            (_a = this.createChangeSummary) === null || _a === void 0 ? void 0 : _a.call(this)
    ...
    handleChange(observable, change) {
        if (this.dependencies.has(observable) && !this.dependenciesToBeRemoved.has(observable)) {
            ...
            if (
                shouldReact &&
                (this.state === 1 /* DerivedState.dependenciesMightHaveChanged */ || wasUpToDate)
            ) {
