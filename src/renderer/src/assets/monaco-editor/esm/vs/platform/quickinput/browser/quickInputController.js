...
export class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        const list = this._register(
            new QuickInputList(container, listId, this.options, this.themeService)
        )
    ...
    setVisibilities(visibilities) {
        ...
        ui.description1.style.display =
            visibilities.description && (visibilities.inputBox || visibilities.checkAll)
                ? ''
                : 'none'
    ...
    hide(reason) {
        ...
        if (!focusChanged) {
            ...
            while (currentElement && !currentElement.offsetParent) {
                currentElement =
                    (_b = currentElement.parentElement) !== null && _b !== void 0 ? _b : undefined
            }
            if (
