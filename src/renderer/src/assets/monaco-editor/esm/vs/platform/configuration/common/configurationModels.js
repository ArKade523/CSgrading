...
export class ConfigurationModel {
    ...
    merge(...others) {
        ...
        for (const other of others) {
            raws.push(
                ...(((_b = other.raw) === null || _b === void 0 ? void 0 : _b.length)
                    ? other.raw
                    : [other])
            )
            if (other.isEmpty()) {
...
export class ConfigurationModelParser {
    ...
    filter(properties, configurationProperties, filterOverriddenProperties, options) {
        ...
        if (
            ...
            !((_a = options === null || options === void 0 ? void 0 : options.exclude) === null ||
            _a === void 0
                ? void 0
                : _a.length)
        ) {
                ...
                if (
                    ...
                    (((_c = options.include) === null || _c === void 0
                        ...
                        ((scope === undefined ||
                            ...
                            options.scopes.includes(scope)) /* Check scopes */ &&
                            !(
    ...
    inspect(key, overrides, workspace) {
        ...
        for (const override of consolidateConfigurationModel.overrides) {
            for (const overrideIdentifier of override.identifiers) {
                if (
                    consolidateConfigurationModel.getOverrideValue(key, overrideIdentifier) !==
                    undefined
                ) {
