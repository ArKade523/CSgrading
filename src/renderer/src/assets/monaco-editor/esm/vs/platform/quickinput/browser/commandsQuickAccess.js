        ...
        async _getPicks(filter, _disposables, token, runOptions) {
            ...
            const runTfidf = createSingleCallFunction(() => {
                ...
                return normalizeTfIdfScores(result)
                    .filter(
                        (score) =>
                            score.score > AbstractCommandsQuickAccessProvider_1.TFIDF_THRESHOLD
                    )
            ...
            for (let i = 0; i < filteredCommandPicks.length; i++) {
                ...
                if (
                    ...
                    ((_c = this.options.suggestedCommandIds) === null || _c === void 0
                        ? void 0
                ...
                if (
                    ...
                    commandPick.tfIdfScore === undefined &&
                    !this.commandsHistory.peek(commandPick.commandId) &&
                    !((_d = this.options.suggestedCommandIds) === null || _d === void 0
                        ? void 0
            ...
            return {
                ...
                additionalPicks: (async () => {
                    ...
                    const commandPicks = additionalCommandPicks.map((commandPick) =>
                    ...
                    if (
                        ...
                        ((_a = commandPicks[0]) === null || _a === void 0 ? void 0 : _a.type) !==
                            'separator'
                    ) {
                        ...
                        from:
                            (_a =
                                runOptions === null || runOptions === void 0
                                    ? void 0
                                    : runOptions.from) !== null && _a !== void 0
                                ? _a
                                : 'quick open'
                    })
                    // Run
...
let CommandsHistory = (CommandsHistory_1 = class CommandsHistory extends Disposable {
    ...
    updateConfiguration(e) {
        ...
        this.configuredCommandsHistoryLength = CommandsHistory_1.getConfiguredCommandHistoryLength(
    ...
    static getConfiguredCommandHistoryLength(configurationService) {
        ...
        const configuredCommandHistoryLength =
            (_b =
                (_a = config.workbench) === null || _a === void 0 ? void 0 : _a.commandPalette) ===
                null || _b === void 0
                ? void 0
                : _b.history
