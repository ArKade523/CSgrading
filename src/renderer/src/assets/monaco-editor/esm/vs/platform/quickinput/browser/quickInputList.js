    ...
    constructor(
        ...
        if (mainItem.type === 'separator') {
            ...
            this._labelHighlights =
                (_a = this.item.highlights) === null || _a === void 0 ? void 0 : _a.label
            this._descriptionHighlights =
                (_b = this.item.highlights) === null || _b === void 0 ? void 0 : _b.description
            this._detailHighlights =
                (_c = this.item.highlights) === null || _c === void 0 ? void 0 : _c.detail
...
class ListElementRenderer {
    ...
    renderElement(element, index, data) {
        ...
        if ((_b = element.item) === null || _b === void 0 ? void 0 : _b.iconPath) {
            ...
            data.icon.className = (
                (_d = element.item) === null || _d === void 0 ? void 0 : _d.iconClass
            )
                            ...
                            (_f =
                                (_d =
                                    (_b =
                                        ...
                                        ? _b
                                        : (_c = element.item) === null || _c === void 0
                                          ? void 0
                                          : _c.label) !== null && _d !== void 0
                                    ? _d
                                    : (_e = element.separator) === null || _e === void 0
                                      ? void 0
                                      : _e.id) !== null && _f !== void 0
                                ? _f
                                : (_g = element.separator) === null || _g === void 0
                                  ? void 0
    ...
    setElements(inputElements) {
        ...
        this.elements = inputElements.reduce((result, item, index) => {
            ...
            elementsToIndexes.set(
                (_a = element.item) !== null && _a !== void 0 ? _a : element.separator,
                resultIndex
            )
            return result
        }, [])
