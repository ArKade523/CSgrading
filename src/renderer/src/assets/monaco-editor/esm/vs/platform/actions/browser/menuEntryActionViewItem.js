...
let SubmenuEntryActionViewItem = class SubmenuEntryActionViewItem extends DropdownMenuActionViewItem {
    constructor(action, options, _keybindingService, _contextMenuService, _themeService) {
        ...
        const dropdownOptions = {
            ...options,
            menuAsChild:
                (_a = options === null || options === void 0 ? void 0 : options.menuAsChild) !==
                    null && _a !== void 0
                    ? _a
                    : false,
            classNames:
...
let DropdownWithDefaultActionViewItem = class DropdownWithDefaultActionViewItem extends BaseActionViewItem {
    constructor(
        ...
        const defaultActionId = (
            options === null || options === void 0 ? void 0 : options.persistLastActionId
        )
        ...
        const dropdownOptions = {
            ...
            actionRunner:
                (_c = options === null || options === void 0 ? void 0 : options.actionRunner) !==
                    null && _c !== void 0
                    ? _c
                    : new ActionRunner()
        }
        ...
        this._register(
            addDisposableListener(dropdownContainer, EventType.KEY_DOWN, (e) => {
                ...
                if (event.equals(15 /* KeyCode.LeftArrow */)) {
                    ...
                    ;(_a = this._defaultAction.element) === null || _a === void 0
                        ? void 0
                        : _a.focus()
                    event.stopPropagation()
                }
