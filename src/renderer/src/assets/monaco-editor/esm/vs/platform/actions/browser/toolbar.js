...
let WorkbenchToolBar = class WorkbenchToolBar extends ToolBar {
    constructor(
        ...
        super(container, _contextMenuService, {
            ...
            getKeyBinding: (action) => {
                var _a
                return (_a = keybindingService.lookupKeybinding(action.id)) !== null &&
                    _a !== void 0
                    ? _a
                    : undefined
            },
        ...
        const telemetrySource =
            _options === null || _options === void 0 ? void 0 : _options.telemetrySource
        if (telemetrySource) {
            this._store.add(
    ...
    setActions(_primary, _secondary = [], menuIds) {
                ...
                if (action.hideActions.isHidden) {
                    ...
                    if (
                        ((_b = this._options) === null || _b === void 0
                            ? void 0
                            : _b.hiddenItemStrategy) !== 0 /* HiddenItemStrategy.Ignore */
                    ) {
        ...
        // count for max
        if (
            ((_c = this._options) === null || _c === void 0 ? void 0 : _c.overflowBehavior) !==
            undefined
        ) {
            const exemptedIds = intersection(
                new Set(this._options.overflowBehavior.exempted),
                Iterable.map(primary, (a) => (a === null || a === void 0 ? void 0 : a.id))
            )
                ...
                addDisposableListener(this.getElement(), 'contextmenu', (e) => {
                    ...
                    if (
                        ...
                        ((_a = this._options) === null || _a === void 0
                            ? void 0
                            : _a.hiddenItemStrategy) === 0 /* HiddenItemStrategy.Ignore */
                    ) {
                        noHide = true
                    ...
                    this._contextMenuService.showContextMenu({
                        ...
                        skipTelemetry:
                            typeof ((_e = this._options) === null || _e === void 0
                                ? void 0
    ...
    constructor(
        ...
        const updateToolbar = () => {
            ...
            createAndFillInActionBarActions(
                menu,
                options === null || options === void 0 ? void 0 : options.menuOptions,
                { primary, secondary },
                (_a = options === null || options === void 0 ? void 0 : options.toolbarOptions) ===
                    null || _a === void 0
                    ? void 0
                    : _a.primaryGroup,
                (_b = options === null || options === void 0 ? void 0 : options.toolbarOptions) ===
                    null || _b === void 0
                    ? void 0
                    : _b.shouldInlineSubmenu,
                (_c = options === null || options === void 0 ? void 0 : options.toolbarOptions) ===
                    null || _c === void 0
                    ? void 0
