    ...
    HTMLCompletion2.prototype.doesSupportMarkdown = function () {
        ...
        if (!isDefined(this.supportsMarkdown)) {
            ...
            var documentationFormat =
                (_c =
                    (_b =
                        (_a2 = this.lsOptions.clientCapabilities.textDocument) === null ||
                        _a2 === void 0
                            ? void 0
            ...
            470: (t2) => {
                ...
                var n = {
                        ...
                        for (var s = r3.length - h, c = a < s ? a : s, f = -1, u = 0; u <= c; ++u) {
                            if (u === c) {
                                if (s > c) {
                                    ...
                                    a > c &&
                                        (47 === t3.charCodeAt(o + u) ? (f = u) : 0 === u && (f = 0))
                                break
                            }
                    ...
                    extname: function (t3) {
                        e2(t3)
                        for (
                            var r3 = -1, n2 = 0, o = -1, i = true, a = 0, h = t3.length - 1;
                            h >= 0;
                            --h
                        ) {
                    ...
                    d = (function () {
                        ...
                        return (
                            ...
                            (t3.file = function (t4) {
                                var e3 = l
                                if (
                                    (n && (t4 = t4.replace(/\\/g, p)), t4[0] === p && t4[1] === p)
                                ) {
