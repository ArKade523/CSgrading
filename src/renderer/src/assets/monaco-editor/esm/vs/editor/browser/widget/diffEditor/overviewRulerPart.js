    ...
    constructor(
        ...
        const diffOverviewRoot = h('div.diffOverview', {
            style: {
                position: 'absolute',
                top: '0px',
                width: OverviewRulerPart_1.ENTIRE_DIFF_OVERVIEW_WIDTH + 'px'
            }
        }).root
        ...
        this._register(
            autorunWithStore((reader, store) => {
                ...
                if (originalOverviewRuler) {
                    ...
                    store.add(
                        appendRemoveOnDispose(diffOverviewRoot, originalOverviewRuler.getDomNode())
                    )
                }
                ...
                if (modifiedOverviewRuler) {
                    ...
                    store.add(
                        appendRemoveOnDispose(diffOverviewRoot, modifiedOverviewRuler.getDomNode())
                    )
                }
                ...
                store.add(
                    autorun((reader) => {
                        ...
                        const diff =
                            (_a = m === null || m === void 0 ? void 0 : m.diff.read(reader)) ===
                                null || _a === void 0
                                ? void 0
                                : _a.mappings
                        ...
                        originalOverviewRuler === null || originalOverviewRuler === void 0
                            ? void 0
                            : originalOverviewRuler.setZones(originalZones)
                        modifiedOverviewRuler === null || modifiedOverviewRuler === void 0
                            ? void 0
                ...
                store.add(
                    autorun((reader) => {
                        ...
                        if (layoutInfo) {
                            const freeSpace =
                                OverviewRulerPart_1.ENTIRE_DIFF_OVERVIEW_WIDTH -
                                2 * OverviewRulerPart_1.ONE_OVERVIEW_WIDTH
...
OverviewRulerPart = OverviewRulerPart_1 = __decorate([__param(6, IThemeService)], OverviewRulerPart)
