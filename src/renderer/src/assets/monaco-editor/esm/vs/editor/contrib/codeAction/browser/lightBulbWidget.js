    ...
    constructor(_editor, _keybindingService, commandService) {
        ...
        this._register(
            dom.addStandardDisposableGenericMouseDownListener(this._domNode, (e) => {
                ...
                const option = this._editor.getOption(64 /* EditorOption.lightbulb */).experimental
                    .showAiIcon
                if (
        ...
        this._register(
            Event.runAndSubscribe(this._keybindingService.onDidUpdateKeybindings, () => {
                ...
                this._preferredKbLabel =
                    (_b =
                        (_a = this._keybindingService.lookupKeybinding(autoFixCommandId)) ===
                            null || _a === void 0
                            ? void 0
                ...
                this._quickFixKbLabel =
                    (_d =
                        (_c = this._keybindingService.lookupKeybinding(quickFixCommandId)) ===
                            null || _c === void 0
                            ? void 0
        ...
        if (option === ShowAiIconMode.On || option === ShowAiIconMode.OnCode) {
            if (option === ShowAiIconMode.On && this.state.actions.allAIFixes) {
                ...
                if (this.state.actions.allAIFixes && this.state.actions.validActions.length === 1) {
                    if (
                        ((_a = this.state.actions.validActions[0].action.command) === null ||
                        _a === void 0
                            ? void 0
                            : _a.id) === `inlineChat.start`
                    ) {
                        const keybinding =
                            (_c =
                                (_b =
                                    ...
                                    ? void 0
                                    : _b.getLabel()) !== null && _c !== void 0
                                ? _c
                                : undefined
                        this.title = keybinding
                            ? nls.localize(
                                  'codeActionStartInlineChatWithKb',
                                  'Start Inline Chat ({0})',
                                  keybinding
                              )
                            : nls.localize('codeActionStartInlineChat', 'Start Inline Chat')
                    } else {
