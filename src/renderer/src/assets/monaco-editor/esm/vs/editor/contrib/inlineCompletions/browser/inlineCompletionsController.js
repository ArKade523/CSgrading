...
let InlineCompletionsController =
    (InlineCompletionsController_1 = class InlineCompletionsController extends Disposable {
        static get(editor) {
        ...
        constructor(
            ...
            this._enabled = observableFromEvent(
                ...
                () => this.editor.getOption(62 /* EditorOption.inlineSuggest */).enabled
            )
            ...
            this._textModel = observableFromEvent(this.editor.onDidChangeModel, () =>
                        ...
                        if (textModel) {
                            const model = _instantiationService.createInstance(
                                ...
                                observableFromEvent(
                                    ...
                                    () => editor.getOption(117 /* EditorOption.suggest */).preview
                                ),
                                observableFromEvent(
                                    editor.onDidChangeConfiguration,
                                    () =>
                                        editor.getOption(117 /* EditorOption.suggest */).previewMode
                                ),
                                observableFromEvent(
                                    editor.onDidChangeConfiguration,
                                    () => editor.getOption(62 /* EditorOption.inlineSuggest */).mode
                                ),
                                this._enabled
                            )
            ...
            this._register(
                autorunHandleChanges(
                    ...
                    async (reader) => {
                        ...
                        const state =
                            model === null || model === void 0 ? void 0 : model.state.read(reader)
        ...
        provideScreenReaderUpdate(content) {
            ...
            if (
                ...
                this.editor.getOption(147 /* EditorOption.inlineCompletionsAccessibilityVerbose */)
            ) {
                hint = localize(
        ...
        updateObservables(tx, changeReason) {
            ...
            this._textModelVersionId.set(
                (_a =
                    newModel === null || newModel === void 0 ? void 0 : newModel.getVersionId()) !==
                    null && _a !== void 0
                    ? _a
                    : -1,
                tx,
