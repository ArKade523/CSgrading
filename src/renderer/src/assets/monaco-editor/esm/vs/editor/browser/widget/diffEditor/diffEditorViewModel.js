...
let DiffEditorViewModel = class DiffEditorViewModel extends Disposable {
                ...
                for (let i = 0; i < lastUnchangedRegions.regions.length; i++) {
                    if (
                        ...
                        r.setHiddenModifiedRange(
                            lastUnchangedRegions.regions[i].getHiddenModifiedRange(undefined),
                            tx
                        )
                        break
                    }
    ...
    ensureModifiedLineIsVisible(lineNumber, tx) {
        var _a
        if (
            ((_a = this.diff.get()) === null || _a === void 0 ? void 0 : _a.mappings.length) === 0
        ) {
            return
        }
...
export class UnchangedRegion {
    ...
    constructor(
        ...
        this._shouldHideControls = derived(
            this,
            (reader) =>
                /** @description isVisible */ this.visibleLineCountTop.read(reader) +
