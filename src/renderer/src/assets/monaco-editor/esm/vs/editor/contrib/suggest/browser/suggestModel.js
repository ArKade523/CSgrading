...
let SuggestModel = (SuggestModel_1 = class SuggestModel {
    ...
    _doTriggerQuickSuggest() {
        ...
        if (
            ...
            ((_a = SnippetController2.get(this._editor)) === null || _a === void 0
                ? void 0
                : _a.isInSnippet())
        ) {
    ...
    trigger(options) {
        ...
        const { itemKind: itemKindFilter, showDeprecated } = SuggestModel_1._createSuggestFilter(
            this._editor
        )
        ...
        Promise.all([completions, wordDistance])
            .then(async ([completions, wordDistance]) => {
                ...
                const fuzzySearchOptions = {
                    ...
                    firstMatchCanBeWeak: !this._editor.getOption(117 /* EditorOption.suggest */)
                ...
                this._completionModel = new CompletionModel(
                    ...
                    wordDistance,
                    this._editor.getOption(117 /* EditorOption.suggest */),
                    this._editor.getOption(111 /* EditorOption.snippetSuggestions */),
                    fuzzySearchOptions,
                    clipboardText
                )
