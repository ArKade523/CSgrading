                ...
                transaction((tx) => {
                    ...
                    if (p) {
                        const nextGroup = groups.findIndex(
                            (g) =>
                                (p === null || p === void 0 ? void 0 : p.lineNumber) <
        ...
        this._register(
            autorun((reader) => {
                ...
                if (currentViewItem && currentViewItem.type !== LineType.Header) {
                    const lineNumber =
                        (_a = currentViewItem.modifiedLineNumber) !== null && _a !== void 0
                            ? _a
    ...
    _render(store) {
        ...
        for (const viewItem of (group === null || group === void 0 ? void 0 : group.lines) || []) {
            ...
            const isSelectedObs = derived(
                (reader) =>
                    /** @description isSelected */ this._model.currentElement.read(reader) ===
                    viewItem
            )
            store.add(
                autorun((reader) => {
    ...
    _getLineHtml(model, options, tabSize, lineNumber, languageIdCodec) {
        ...
        const r = renderViewLine2(
            new RenderLineInput(
                ...
                options.get(51 /* EditorOption.fontLigatures */) !== EditorFontLigatures.OFF,
                null
            )
        )
        return r.html
