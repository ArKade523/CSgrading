    ...
    CoreNavigationCommands.CursorLineStartSelect = registerEditorCommand(
        new LineStartCommand({
            ...
            kbOpts: {
                ...
                mac: {
                    primary:
                        256 /* KeyMod.WinCtrl */ | 1024 /* KeyMod.Shift */ | 31 /* KeyCode.KeyA */
                }
            }
        })
    )
    ...
    CoreNavigationCommands.CursorLineEndSelect = registerEditorCommand(
        new LineEndCommand({
            ...
            kbOpts: {
                ...
                mac: {
                    primary:
                        256 /* KeyMod.WinCtrl */ | 1024 /* KeyMod.Shift */ | 35 /* KeyCode.KeyE */
                }
            }
        })
    )
    ...
    CoreNavigationCommands.CursorTopSelect = registerEditorCommand(
        new TopCommand({
            ...
            kbOpts: {
                ...
                kbExpr: EditorContextKeys.textInputFocus,
                primary:
                    2048 /* KeyMod.CtrlCmd */ | 1024 /* KeyMod.Shift */ | 14 /* KeyCode.Home */,
                mac: {
                    primary:
                        2048 /* KeyMod.CtrlCmd */ |
                        1024 /* KeyMod.Shift */ |
