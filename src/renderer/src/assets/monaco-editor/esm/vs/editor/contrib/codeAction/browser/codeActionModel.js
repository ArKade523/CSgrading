        ...
        if (selection.isEmpty() && trigger.type === 2 /* CodeActionTriggerType.Auto */) {
            ...
            if (line.length === 0) {
                ...
                const showAiIconOnEmptyLines =
                    ((_a = this._editor.getOption(64 /* EditorOption.lightbulb */).experimental) ===
                        null || _a === void 0
                        ? void 0
                        : _a.showAiIcon) === ShowAiIconMode.On
        ...
        if (
            ...
            this._codeActionOracle.value = new CodeActionOracle(
                ...
                (trigger) => {
                    ...
                    const actions = createCancelablePromise(async (token) => {
                        ...
                        if (
                            ...
                            (trigger.trigger.triggerAction === CodeActionTriggerSource.QuickFix ||
                                ((_b =
                                    (_a = trigger.trigger.filter) === null || _a === void 0
                                        ? void 0
                            ...
                            const foundQuickfix =
                                (_c = codeActionSet.validActions) === null || _c === void 0
                                    ? void 0
                                    : _c.some((action) =>
                                          action.action.kind
                                    ...
                                    for (const marker of allMarkers) {
                                        ...
                                        if (
                                            ...
                                            const newCodeActionTrigger = {
                                                ...
                                                filter: {
                                                    include: (
                                                        (_d = trigger.trigger.filter) === null ||
                                                        _d === void 0
                                                            ? void 0
                                                            : _d.include
                                                    )
                                                        ? (_e = trigger.trigger.filter) === null ||
                                                          _e === void 0
                                                            ? void 0
                                                            : _e.include
                                                ...
                                                context: {
                                                    notAvailableMessage:
                                                        ((_f = trigger.trigger.context) === null ||
                                                        _f === void 0
                                                            ? void 0
                                                            : _f.notAvailableMessage) || '',
                                            ...
                                            if (actionsAtMarker.validActions.length !== 0) {
                                                ...
                                                if (
                                                    Math.abs(currPosition.column - col) < distance
                                                ) {
                    ...
                    this.setState(
                        new CodeActionsState.Triggered(trigger.trigger, startPosition, actions)
                    )
                },
                undefined
            )
