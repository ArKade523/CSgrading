...
export class HitTestContext {
    ...
    getFullLineRangeAtCoord(mouseVerticalOffset) {
        ...
        const lineNumber =
            this._context.viewLayout.getLineNumberAtVerticalOffset(mouseVerticalOffset)
        const maxLineColumn = this._context.viewModel.getLineMaxColumn(lineNumber)
        return {
...
class HitTestRequest extends BareHitTestRequest {
    ...
    _getMouseColumn(position = null) {
        if (
            position &&
            position.column < this._ctx.viewModel.getLineMaxColumn(position.lineNumber)
        ) {
...
export class MouseTargetFactory {
    ...
    getMouseColumn(relativePos) {
        ...
        return MouseTargetFactory._getMouseColumn(
            ...
            options.get(50 /* EditorOption.fontInfo */).typicalHalfwidthCharacterWidth
        )
    }
