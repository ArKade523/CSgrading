...
function validateDiffEditorOptions(options, defaults) {
    ...
    return {
        ...
        diffWordWrap: validateStringSetOption(options.diffWordWrap, defaults.diffWordWrap, [
            'off',
            'on',
            'inherit'
        ]),
        ...
        experimental: {
            showMoves: validateBooleanOption(
                (_a = options.experimental) === null || _a === void 0 ? void 0 : _a.showMoves,
        ...
        hideUnchangedRegions: {
            enabled: validateBooleanOption(
                (_d =
                    (_c = options.hideUnchangedRegions) === null || _c === void 0
                        ? void 0
