...
let ViewZoneManager = class ViewZoneManager extends Disposable {
    constructor(
        ...
        const originalModelTokenizationCompleted = this._diffModel
            ...
            .map((m, reader) => (m === null || m === void 0 ? void 0 : m.read(reader)))
        const alignments = derived((reader) => {
            /** @description alignments */
            const diffModel = this._diffModel.read(reader)
            const diff =
                diffModel === null || diffModel === void 0 ? void 0 : diffModel.diff.read(reader)
            if (!diffModel || !diff) {
                return null
            }
            state.read(reader)
        ...
        this.viewZones = derivedWithStore(this, (reader, store) => {
            ...
            const deletedCodeLineBreaksComputer = !renderSideBySide
                ? (_a = this._editors.modified._getViewModel()) === null || _a === void 0
                    ? void 0
                        ...
                        for (
                            ...
                            deletedCodeLineBreaksComputer === void 0
                                ...
                                : deletedCodeLineBreaksComputer.addRequest(
                                      this._editors.original.getModel().getLineContent(i),
                                      null,
                                      null
                                  )
                        }
            ...
            const lineBreakData =
                (_b =
                    ...
                    deletedCodeLineBreaksComputer === void 0
                        ? void 0
                        : deletedCodeLineBreaksComputer.finalize()) !== null && _b !== void 0
                    ? _b
                    : []
            ...
            const mightContainNonBasicASCII =
                (_e =
                    (_d = this._editors.original.getModel()) === null || _d === void 0
                        ? void 0
                        : _d.mightContainNonBasicASCII()) !== null && _e !== void 0
                    ? _e
                    : false
            const mightContainRTL =
                (_g =
                    (_f = this._editors.original.getModel()) === null || _f === void 0
                        ? void 0
                    ...
                    if (!a.originalRange.isEmpty) {
                        ...
                        const source = new LineSource(
                            a.originalRange.mapToLineArray((l) =>
                                this._editors.original.getModel().tokenization.getLineTokens(l)
                            ),
            ...
            for (const a of (_h = alignmentsSyncedMovedText.read(reader)) !== null && _h !== void 0
                ? _h
                : []) {
                if (
                    !(syncedMovedText === null || syncedMovedText === void 0
    ...
    function handleAlignmentsOutsideOfDiffs(
        ...
        while (true) {
            ...
            if (distOrig < distNext) {
                ...
                modNext = {
                    lineNumber:
                        origNext.lineNumber - lastOriginalLineNumber + lastModifiedLineNumber,
                    heightInPx: 0
                }
                ...
                origNext = {
                    lineNumber:
                        modNext.lineNumber - lastModifiedLineNumber + lastOriginalLineNumber,
                    heightInPx: 0
                }
            } else {
                originalLineHeightOverrides.dequeue()
            ...
            const originalAdditionalHeight =
                (_b =
                    (_a = originalLineHeightOverrides.takeWhile(
                        ...
                        ? void 0
                        : _a.reduce((p, c) => p + c.heightInPx, 0)) !== null && _b !== void 0
                    ? _b
                    : 0
            const modifiedAdditionalHeight =
                (_d =
                    (_c = modifiedLineHeightOverrides.takeWhile(
                        ...
                        ? void 0
                        : _c.reduce((p, c) => p + c.heightInPx, 0)) !== null && _d !== void 0
                    ? _d
                    : 0
            result.push({
                originalRange,
        ...
        if (innerHunkAlignment) {
            for (const i of c.innerChanges || []) {
                ...
                if (
                    ...
                    originalEditor.getModel().getLineMaxColumn(i.originalRange.endLineNumber)
                ) {
