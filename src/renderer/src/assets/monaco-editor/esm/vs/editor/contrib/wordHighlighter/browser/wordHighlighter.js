...
let WordHighlighter = (WordHighlighter_1 = class WordHighlighter {
    ...
    _removeAllDecorations() {
        ...
        for (const editor of currentEditors) {
            ...
            if (
                !(editorHighlighterContrib === null || editorHighlighterContrib === void 0
                    ? void 0
    ...
    _stopSingular() {
        ...
        if (this.editor.hasWidgetFocus()) {
            if (
                ...
                if (
                    (_d = WordHighlighter_1.query) === null || _d === void 0 ? void 0 : _d.modelInfo
                ) {
    ...
    _onPositionChanged(e) {
        ...
        if (
            ...
            ((_a = this.editor.getModel()) === null || _a === void 0 ? void 0 : _a.uri.scheme) !==
    ...
    _run() {
        ...
        if (workerRequestIsValid) {
            ...
            const sendWord =
                (!WordHighlighter_1.query.modelInfo && WordHighlighter_1.query.word) ||
                ((_a = WordHighlighter_1.query.modelInfo) === null || _a === void 0
                    ? void 0
    ...
    renderDecorations() {
        ...
        for (const editor of currentEditors) {
            ...
            if (uri && this.workerRequestValue.has(uri)) {
                ...
                WordHighlighter_1.storedDecorations = WordHighlighter_1.storedDecorations.set(
                    uri,
                    newDecorationIDs
                )
                if (newDecorations.length > 0) {
                    ;(_b = editorHighlighterContrib.wordHighlighter) === null || _b === void 0
                        ? void 0
                        : _b.decorations.set(newDecorations)
                    ;(_c = editorHighlighterContrib.wordHighlighter) === null || _c === void 0
                        ? void 0
...
let WordHighlighterContribution =
    (WordHighlighterContribution_1 = class WordHighlighterContribution extends Disposable {
        static get(editor) {
