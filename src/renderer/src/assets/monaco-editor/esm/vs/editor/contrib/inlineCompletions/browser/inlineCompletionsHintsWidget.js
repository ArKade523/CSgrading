...
let InlineCompletionsHintsWidget = class InlineCompletionsHintsWidget extends Disposable {
    constructor(editor, model, instantiationService) {
        ...
        this.alwaysShowToolbar = observableFromEvent(
            ...
            () =>
                this.editor.getOption(62 /* EditorOption.inlineSuggest */).showToolbar === 'always'
        )
            ...
            autorunWithStore((reader, store) => {
                ...
                const contentWidget = store.add(
                    this.instantiationService.createInstance(
                        ...
                        model.selectedInlineCompletion.map((v) => /** @description commands */ {
                            var _a
                            /** @description commands */ return (_a =
                                v === null || v === void 0
                                    ? void 0
                                    : v.inlineCompletion.source.inlineCompletions.commands) !==
                                null && _a !== void 0
                                ? _a
                                : []
                        })
...
let CustomizedMenuWorkbenchToolBar = class CustomizedMenuWorkbenchToolBar extends WorkbenchToolBar {
    ...
    updateToolbar() {
        ...
        createAndFillInActionBarActions(
            ...
            { primary, secondary },
            (_c = (_b = this.options2) === null || _b === void 0 ? void 0 : _b.toolbarOptions) ===
                null || _c === void 0
                ? void 0
                : _c.primaryGroup,
            (_e = (_d = this.options2) === null || _d === void 0 ? void 0 : _d.toolbarOptions) ===
                null || _e === void 0
                ? void 0
                : _e.shouldInlineSubmenu,
            (_g = (_f = this.options2) === null || _f === void 0 ? void 0 : _f.toolbarOptions) ===
                null || _g === void 0
                ? void 0
