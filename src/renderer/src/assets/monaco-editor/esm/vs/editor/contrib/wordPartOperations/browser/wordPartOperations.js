    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary:
                        256 /* KeyMod.WinCtrl */ | 512 /* KeyMod.Alt */ | 1 /* KeyCode.Backspace */
                },
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary:
                        256 /* KeyMod.WinCtrl */ | 512 /* KeyMod.Alt */ | 20 /* KeyCode.Delete */
                },
                weight: 100 /* KeybindingWeight.EditorContrib */
            }
        })
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: {
                    primary:
                        256 /* KeyMod.WinCtrl */ | 512 /* KeyMod.Alt */ | 15 /* KeyCode.LeftArrow */
                },
                weight: 100 /* KeybindingWeight.EditorContrib */
            }
        })
