...
let CopyPasteController = (CopyPasteController_1 = class CopyPasteController extends Disposable {
    ...
    async handlePaste(e) {
        ...
        const allPotentialMimeTypes = [
            ...
            ...((_b =
                metadata === null || metadata === void 0
                    ? void 0
                    : metadata.providerCopyMimeTypes) !== null && _b !== void 0
                ? _b
                : []),
        ...
        const allProviders = this._languageFeaturesService.documentPasteEditProvider
            ...
            .filter((provider) => {
                var _a
                return (_a = provider.pasteMimeTypes) === null || _a === void 0
                    ? void 0
                    : _a.some((type) => matchesMimeType(type, allPotentialMimeTypes))
            })
        ...
        const p = createCancelablePromise(async (token) => {
            ...
            try {
                ...
                if (providerEdits.length) {
                    const canShowWidget =
                        editor.getOption(84 /* EditorOption.pasteAs */).showPasteSelector ===
                        'afterPaste'
        ...
        if (metadata) {
            return {
                defaultPastePayload: {
                    mode: metadata.mode,
                    multicursorText:
                        (_a = metadata.multicursorText) !== null && _a !== void 0 ? _a : null,
    ...
    async mergeInDataFromCopy(dataTransfer, metadata, token) {
        ...
        if (
            ...
            ((_a = this._currentCopyOperation) === null || _a === void 0 ? void 0 : _a.handle) ===
                metadata.id
        ) {
        ...
        const results = await raceCancellation(
            Promise.all(
                providers.map(async (provider) => {
                    var _a
                    try {
                        const edit = await ((_a = provider.provideDocumentPasteEdits) === null ||
                        _a === void 0
                            ? void 0
                            : _a.call(provider, model, selections, dataTransfer, token))
                        if (edit) {
        ...
        const payload = {
            ...
            pasteOnNewLine:
                (_b =
                    metadata === null || metadata === void 0
                        ? void 0
                        : metadata.defaultPastePayload.pasteOnNewLine) !== null && _b !== void 0
                    ? _b
                    : false,
            multicursorText:
                (_c =
                    metadata === null || metadata === void 0
                        ? void 0
                        : metadata.defaultPastePayload.multicursorText) !== null && _c !== void 0
                    ? _c
                    : null,
            mode: null
        }
