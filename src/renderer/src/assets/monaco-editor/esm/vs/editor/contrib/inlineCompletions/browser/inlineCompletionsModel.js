...
let InlineCompletionsModel = class InlineCompletionsModel extends Disposable {
        ...
        this._fetchInlineCompletions = derivedHandleChanges(
            ...
            (reader, changeSummary) => {
                ...
                const itemToPreserve =
                    ...
                    (itemToPreserveCandidate === null || itemToPreserveCandidate === void 0
                        ? void 0
        ...
        this.state = derivedOpts(
            ...
            (reader) => {
                ...
                if (suggestItem) {
                    ...
                    return ghostText
                        ? { ghostText, inlineCompletion: item, suggestItem: undefined }
                        : undefined
                }
            }
        )
    ...
    async accept(editor) {
        ...
        if (completion.snippetInfo) {
            ...
            ;(_a = SnippetController2.get(editor)) === null || _a === void 0
                ? void 0
                : _a.insert(completion.snippetInfo.snippet, { undoStopBefore: false })
        } else {
            editor.executeEdits('inlineSuggestion.accept', [
    ...
    async _acceptNext(editor, getAcceptUntilIndex) {
        ...
        try {
            ...
            if (completion.source.provider.handlePartialAccept) {
                ...
                const text = editor
                    .getModel()
                    .getValueInRange(acceptedRange, 1 /* EndOfLinePreference.LF */)
    ...
    handleSuggestAccepted(item) {
        ...
        ;(_b = (_a = inlineCompletion.source.provider).handlePartialAccept) === null ||
        _b === void 0
            ? void 0
            : _b.call(
                  _a,
