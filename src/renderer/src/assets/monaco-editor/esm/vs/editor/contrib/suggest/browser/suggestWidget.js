...
class PersistedWidgetSize {
    ...
    restore() {
        var _a
        const raw =
            (_a = this._service.get(this._key, 0 /* StorageScope.PROFILE */)) !== null &&
            _a !== void 0
                ? _a
                : ''
        try {
...
let SuggestWidget = (SuggestWidget_1 = class SuggestWidget {
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
            ...
            this.element.onDidResize((e) => {
                ...
                if (state) {
                    ...
                    if (
                        ...
                        height =
                            (_b =
                                (_a = state.persistedSize) === null || _a === void 0
                                    ? void 0
                    ...
                    if (
                        ...
                        width =
                            (_d =
                                (_c = state.persistedSize) === null || _c === void 0
                                    ? void 0
        ...
        const applyStatusBarStyle = () =>
            this.element.domNode.classList.toggle(
                'with-status-bar',
                this.editor.getOption(117 /* EditorOption.suggest */).showStatusBar
            )
        applyStatusBarStyle()
    ...
    _layout(size) {
        ...
        if (this._state === 2 /* State.Empty */ || this._state === 1 /* State.Loading */) {
            ...
            if (
                height ===
                ((_a = this._cappedHeight) === null || _a === void 0 ? void 0 : _a.capped)
            ) {
            ...
            this._cappedHeight =
                height === fullHeight
                    ? {
                          wanted:
                              (_c =
                                  (_b = this._cappedHeight) === null || _b === void 0
                                      ? void 0
    ...
    getLayoutInfo() {
        ...
        const itemHeight = clamp(
            this.editor.getOption(119 /* EditorOption.suggestLineHeight */) || fontInfo.lineHeight,
            8,
            1000
        )
