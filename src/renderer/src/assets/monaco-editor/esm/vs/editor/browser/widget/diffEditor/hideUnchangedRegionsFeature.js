...
let HideUnchangedRegionsFeature = class HideUnchangedRegionsFeature extends Disposable {
    ...
    constructor(_editors, _diffModel, _options, _languageFeaturesService) {
        ...
        const unchangedRegions = this._diffModel.map((m, reader) => {
            var _a, _b
            return ((_a = m === null || m === void 0 ? void 0 : m.diff.read(reader)) === null ||
            _a === void 0
                ? void 0
                : _a.mappings.length) === 0
                ? []
                : (_b = m === null || m === void 0 ? void 0 : m.unchangedRegions.read(reader)) !==
                        null && _b !== void 0
                  ? _b
                  : []
        })
...
class CollapsedCodeOverlayWidget extends ViewZoneOverlayWidget {
    constructor(
        ...
        if (!this._hide) {
            this._register(
                applyStyle(this._nodes.first, { width: layoutInfo.map((l) => l.contentLeft) })
            )
        } else {
            ...
            addDisposableListener(this._nodes.top, 'mousedown', (e) => {
                ...
                const mouseMoveListener = addDisposableListener(window, 'mousemove', (e) => {
                    ...
                    const lineDelta = Math.round(
                        delta / editor.getOption(66 /* EditorOption.lineHeight */)
                    )
...
OutlineSource = __decorate([__param(0, ILanguageFeaturesService)], OutlineSource)
