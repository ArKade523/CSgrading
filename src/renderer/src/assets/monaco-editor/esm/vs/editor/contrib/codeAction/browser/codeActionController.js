        ...
        if (newState.trigger.type === 1 /* CodeActionTriggerType.Invoke */) {
            if ((_c = newState.trigger.filter) === null || _c === void 0 ? void 0 : _c.include) {
                ...
                if (validActionToApply) {
                    try {
                        ;(_d = this._lightBulbWidget.value) === null || _d === void 0
                            ? void 0
                            : _d.hide()
            ...
            const includeDisabledActions = !!((_f = newState.trigger.filter) === null ||
            _f === void 0
                ? void 0
                : _f.include)
            if (newState.trigger.context) {
    ...
    async showCodeActionList(actions, at, options) {
        ...
        const delegate = {
            ...
            onHover: async (action, token) => {
                ...
                return {
                    canPreview: !!((_a = action.action.edit) === null || _a === void 0
                        ? void 0
                        : _a.edits.length)
                }
            },
