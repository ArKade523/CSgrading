    ...
    constructor() {
        super(true, {
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary:
                    512 /* KeyMod.Alt */ | 1024 /* KeyMod.Shift */ | 18 /* KeyCode.DownArrow */,
                linux: {
                    primary:
                        2048 /* KeyMod.CtrlCmd */ |
                        512 /* KeyMod.Alt */ |
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                primary:
                    2048 /* KeyMod.CtrlCmd */ | 1024 /* KeyMod.Shift */ | 41 /* KeyCode.KeyK */,
                weight: 100 /* KeybindingWeight.EditorContrib */
            }
        })
    }
    ...
    run(_accessor, editor) {
        ...
        for (const selection of selections) {
            if (selection.isEmpty()) {
                ...
                textEdits.push(
                    EditOperation.replace(wordRange, this._modifyText(text, wordSeparators))
                )
            } else {
                const text = model.getValueInRange(selection)
                textEdits.push(
                    EditOperation.replace(selection, this._modifyText(text, wordSeparators))
                )
            }
        }
        editor.pushUndoStop()
