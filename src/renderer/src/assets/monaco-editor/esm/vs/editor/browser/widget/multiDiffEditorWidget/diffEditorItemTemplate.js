...
let DiffEditorItemTemplate = class DiffEditorItemTemplate extends Disposable {
    constructor(
        ...
        this.maxScroll = derived(this, (reader) => {
            const scroll1 =
                this._modifiedContentWidth.read(reader) - this._modifiedWidth.read(reader)
            const scroll2 =
                this._originalContentWidth.read(reader) - this._originalWidth.read(reader)
            if (scroll1 > scroll2) {
        ...
        this._resourceLabel = this._workbenchUIElementFactory.createResourceLabel
            ? this._register(
                  this._workbenchUIElementFactory.createResourceLabel(this._elements.title)
              )
            : undefined
                    ...
                    actionRunner: this._register(
                        new ActionRunnerWithContext(() => {
                            ...
                            return (_b =
                                (_a = this._viewModel.get()) === null || _a === void 0
                                    ? void 0
                                    : _a.diffEditorViewModel) === null || _b === void 0
                                ? void 0
                                : _b.model.modified.uri
                        })
                    ),
                    menuOptions: {
    ...
    setData(data) {
            ...
            this._dataStore.add(
                value.onOptionsDidChange(() => {
                    ...
                    this.editor.updateOptions(
                        updateOptions((_a = value.options) !== null && _a !== void 0 ? _a : {})
                    )
                })
            )
        }
        globalTransaction((tx) => {
            ...
            ;(_a = this._resourceLabel) === null || _a === void 0
                ? void 0
                : _a.setUri(data.viewModel.diffEditorViewModel.model.modified.uri)
            this._dataStore.clear()
            this._viewModel.set(data.viewModel, tx)
            this.editor.setModel(data.viewModel.diffEditorViewModel, tx)
            this.editor.updateOptions(
                updateOptions((_b = value.options) !== null && _b !== void 0 ? _b : {})
            )
        })
    }
