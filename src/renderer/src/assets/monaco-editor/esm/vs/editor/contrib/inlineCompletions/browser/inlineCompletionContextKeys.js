        ...
        this._register(
            autorun((reader) => {
                ...
                const isInlineCompletionVisible =
                    !!(state === null || state === void 0 ? void 0 : state.inlineCompletion) &&
                    (state === null || state === void 0 ? void 0 : state.ghostText) !== undefined &&
                    !(state === null || state === void 0 ? void 0 : state.ghostText.isEmpty())
                this.inlineCompletionVisible.set(isInlineCompletionVisible)
                if (
                    (state === null || state === void 0 ? void 0 : state.ghostText) &&
                    (state === null || state === void 0 ? void 0 : state.inlineCompletion)
                ) {
                    this.suppressSuggestions.set(
                        state.inlineCompletion.inlineCompletion.source.inlineCompletions
                            .suppressSuggestions
                    )
                }
            })
        ...
        this._register(
            autorun((reader) => {
                ...
                if (
                    ...
                    const indentationEndColumn = model.textModel.getLineIndentColumn(
