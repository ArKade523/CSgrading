...
let DiffEditorWidget = class DiffEditorWidget extends DelegatingEditor {
    ...
    constructor(
        ...
        this.elements = h(
            ...
            [
                h(
                    ...
                    { style: { position: 'absolute', height: '100%', visibility: 'hidden' } },
                    [$('span', {}, 'No Changes')]
                ),
        ...
        this._layoutInfo = derived(this, (reader) => {
            ...
            const modifiedWidth =
                ...
                originalWidth -
                ((_c =
                    (_b = this._overviewRulerPart.read(reader)) === null || _b === void 0
                        ? void 0
            ...
            const movedBlocksLinesWidth =
                (_e =
                    (_d = this._movedBlocksLinesPart.read(reader)) === null || _d === void 0
                        ? void 0
        ...
        this._rootSizeObserver.setAutomaticLayout(
            (_a = options.automaticLayout) !== null && _a !== void 0 ? _a : false
        )
        ...
        this._register(
            bindContextKey(
                ...
                (reader) => {
                    var _a
                    return !!((_a = this._diffModel.read(reader)) === null || _a === void 0
                        ? void 0
        ...
        this._register(
            bindContextKey(EditorContextKeys.hasChanges, this._contextKeyService, (reader) => {
                var _a, _b, _c
                return (
                    ((_c =
                        (_b =
                            (_a = this._diffModel.read(reader)) === null || _a === void 0
                                ? void 0
                                : _a.diff.read(reader)) === null || _b === void 0
                            ? void 0
                      ...
                      this.elements.root,
                      {
                          ...
                          width: this._rootSizeObserver.width.map((w, reader) => {
                              ...
                              return (
                                  w -
                                  ((_b =
                                      (_a = this._overviewRulerPart.read(reader)) === null ||
                                      _a === void 0
                                          ? void 0
        ...
        this._accessibleDiffViewer = derivedDisposable(this, (reader) =>
            this._instantiationService.createInstance(
                ...
                this._diffModel.map((m, r) => {
                    var _a
                    return (_a = m === null || m === void 0 ? void 0 : m.diff.read(r)) === null ||
                        _a === void 0
                        ? void 0
            ...
            applyStyle(this.elements.overlay, {
                width: this._layoutInfo.map(
                    (i, r) =>
                        ...
                        (this._options.renderSideBySide.read(r) ? 0 : i.modifiedEditor.width)
                ),
    ...
    getModel() {
        var _a, _b
        return (_b = (_a = this._diffModel.get()) === null || _a === void 0 ? void 0 : _a.model) !==
            null && _b !== void 0
            ? _b
            : null
    }
        ...
        if (this._diffModel.get() !== (vm === null || vm === void 0 ? void 0 : vm.model)) {
            subtransaction(tx, (tx) => {
                ...
                this._shouldDisposeDiffModel =
                    (_a = vm === null || vm === void 0 ? void 0 : vm.shouldDispose) !== null &&
                    _a !== void 0
                        ? _a
                        : false
    ...
    getLineChanges() {
        var _a
        const diffState =
            (_a = this._diffModel.get()) === null || _a === void 0 ? void 0 : _a.diff.get()
        if (!diffState) {
            return null
        }
    ...
    revealFirstDiff() {
        ...
        this.waitForDiff().then(() => {
            var _a
            const diffs =
                (_a = diffModel.diff.get()) === null || _a === void 0 ? void 0 : _a.mappings
            if (!diffs || diffs.length === 0) {
                return
            }
            this._goTo(diffs[0])
