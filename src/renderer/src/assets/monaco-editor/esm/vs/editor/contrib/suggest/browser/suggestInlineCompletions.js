    ...
    async provideInlineCompletions(model, position, context, token) {
        ...
        if (
            ...
            const completionModel = new CompletionModel(
                ...
                WordDistance.None,
                this._getEditorOption(117 /* EditorOption.suggest */, model),
                this._getEditorOption(111 /* EditorOption.snippetSuggestions */, model),
        ...
        if (++EditorContribution_1._counter === 1) {
            const provider = instaService.createInstance(SuggestInlineCompletions, (id, model) => {
                ...
                const editor =
                    (_a = editorService
                        .listCodeEditors()
                        .find((editor) => editor.getModel() === model)) !== null && _a !== void 0
                        ? _a
                        : _editor
                return editor.getOption(id)
            })
            EditorContribution_1._disposable =
                languageFeatureService.inlineCompletionsProvider.register('*', provider)
        }
    }
    dispose() {
        var _a
        if (--EditorContribution_1._counter === 0) {
            ;(_a = EditorContribution_1._disposable) === null || _a === void 0
                ? void 0
                : _a.dispose()
