...
export class StickyScrollWidget extends Disposable {
    ...
    async _renderRootNode(previousStickyLines, foldingModel, rebuildFromLine = Infinity) {
        ...
        for (const [index, line] of this._lineNumbers.entries()) {
            ...
            const stickyLine =
                ...
                (previousStickyLine === null || previousStickyLine === void 0
                    ? void 0
    ...
    _setFoldingHoverListeners() {
        ...
        this._foldingIconStore.add(
            dom.addDisposableListener(this._lineNumbersDomNode, dom.EventType.MOUSE_ENTER, (e) => {
    ...
    _renderChildNode(index, line, foldingModel, layoutInfo) {
        ...
        if (
            ...
            (lineNumberOption.renderType === 3 /* RenderLineNumbersType.Interval */ &&
                line % 10 === 0)
        ) {
    ...
    getLineNumberFromChildDomNode(domNode) {
        var _a, _b
        return (_b =
            (_a = this._getRenderedStickyLineFromChildDomNode(domNode)) === null || _a === void 0
                ? void 0
