...
let MarkerController = (MarkerController_1 = class MarkerController {
    ...
    async nagivate(next, multiFile) {
        ...
        if (this._editor.hasModel()) {
            ...
            if (
                model.selected.marker.resource.toString() !== this._editor.getModel().uri.toString()
            ) {
                ...
                if (otherEditor) {
                    ;(_a = MarkerController_1.get(otherEditor)) === null || _a === void 0
                        ? void 0
                        : _a.close()
                    ;(_b = MarkerController_1.get(otherEditor)) === null || _b === void 0
                        ? void 0
