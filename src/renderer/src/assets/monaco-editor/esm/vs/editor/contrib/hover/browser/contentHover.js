...
const $ = dom.$
let ContentHoverController = (ContentHoverController_1 = class ContentHoverController extends (
    Disposable
) {
    constructor(_editor, _instantiationService, _keybindingService) {
        ...
        for (const participant of HoverParticipantRegistry.getAll()) {
            this._participants.push(
                this._instantiationService.createInstance(participant, this._editor)
            )
        }
        ...
        if (fragment.hasChildNodes()) {
            ...
            this._widget.showAt(
                ...
                new ContentHoverVisibleData(
                    ...
                    this._editor.getOption(60 /* EditorOption.hover */).above,
...
let ContentHoverWidget = (ContentHoverWidget_1 = class ContentHoverWidget extends (
    ...
    _updateResizableNodeMaxDimensions() {
        ...
        const maxRenderingWidth =
            (_a = this._findMaximumRenderingWidth()) !== null && _a !== void 0 ? _a : Infinity
        const maxRenderingHeight =
            (_b = this._findMaximumRenderingHeight()) !== null && _b !== void 0 ? _b : Infinity
    ...
    _findAvailableSpaceVertically() {
        var _a
        const position =
            (_a = this._visibleData) === null || _a === void 0 ? void 0 : _a.showAtPosition
        if (!position) {
            return
        }
    ...
    showAt(node, hoverData) {
        ...
        this._positionPreference =
            (_a = this._findPositionPreference(widgetHeight, widgetPosition)) !== null &&
            _a !== void 0
                ? _a
                : 1 /* ContentWidgetPositionPreference.ABOVE */
    ...
    _adjustHoverHeightForScrollbar(height) {
        ...
        const contentsDomNode = this._hover.contentsDomNode
        const maxRenderingHeight =
            (_a = this._findMaximumRenderingHeight()) !== null && _a !== void 0 ? _a : Infinity
