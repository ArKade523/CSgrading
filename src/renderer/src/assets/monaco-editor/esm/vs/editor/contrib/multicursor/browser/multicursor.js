    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                primary:
                    2048 /* KeyMod.CtrlCmd */ | 512 /* KeyMod.Alt */ | 16 /* KeyCode.UpArrow */,
                linux: {
                    primary:
                        1024 /* KeyMod.Shift */ | 512 /* KeyMod.Alt */ | 16 /* KeyCode.UpArrow */,
                    secondary: [
                        2048 /* KeyMod.CtrlCmd */ |
                            1024 /* KeyMod.Shift */ |
                            16 /* KeyCode.UpArrow */
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary:
                    2048 /* KeyMod.CtrlCmd */ | 512 /* KeyMod.Alt */ | 18 /* KeyCode.DownArrow */,
                linux: {
                    primary:
                        1024 /* KeyMod.Shift */ | 512 /* KeyMod.Alt */ | 18 /* KeyCode.DownArrow */,
                    secondary: [
                        2048 /* KeyMod.CtrlCmd */ |
                            1024 /* KeyMod.Shift */ |
...
export class MultiCursorSession {
    ...
    selectAll(searchScope) {
        ...
        return editorModel.findMatches(
            ...
            false,
            this.matchCase,
            this.wholeWord ? this._editor.getOption(129 /* EditorOption.wordSeparators */) : null,
            false,
            1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */
        )
    }
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary:
                    2048 /* KeyMod.CtrlCmd */ | 1024 /* KeyMod.Shift */ | 42 /* KeyCode.KeyL */,
                weight: 100 /* KeybindingWeight.EditorContrib */
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
...
let SelectionHighlighter = (SelectionHighlighter_1 = class SelectionHighlighter extends Disposable {
    ...
    _update() {
        this._setState(
            SelectionHighlighter_1._createState(this.state, this._isEnabled, this.editor)
        )
    }
    static _createState(oldState, isEnabled, editor) {
        ...
        return new SelectionHighlighterState(
            ...
            r.searchText,
            r.matchCase,
            r.wholeWord ? editor.getOption(129 /* EditorOption.wordSeparators */) : null,
            oldState
        )
    }
    _setState(newState) {
        ...
        const occurrenceHighlighting =
            this.editor.getOption(80 /* EditorOption.occurrencesHighlight */) !== 'off'
