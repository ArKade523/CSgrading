...
let FoldingController = (FoldingController_1 = class FoldingController extends Disposable {
    ...
    static getFoldingRangeProviders(languageFeaturesService, model) {
        ...
        return (_b =
            (_a = FoldingController_1._foldingRangeSelector) === null || _a === void 0
                ? void 0
                : _a.call(FoldingController_1, foldingRangeProviders, model)) !== null &&
            _b !== void 0
            ? _b
    ...
    constructor(
        ...
        this._useFoldingProviders =
            options.get(44 /* EditorOption.foldingStrategy */) !== 'indentation'
        ...
        this._register(
            this.editor.onDidChangeConfiguration((e) => {
                ...
                if (e.hasChanged(44 /* EditorOption.foldingStrategy */)) {
                    this._useFoldingProviders =
                        this.editor.getOptions().get(44 /* EditorOption.foldingStrategy */) !==
                        'indentation'
    ...
    getRangeProvider(editorModel) {
        ...
        if (this._useFoldingProviders && this.foldingModel) {
            const selectedProviders = FoldingController_1.getFoldingRangeProviders(
