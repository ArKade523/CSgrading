...
export class UpToDateInlineCompletions {
    ...
    prepend(inlineCompletion, range, addRefToSource) {
        ...
        this._inlineCompletions.unshift(
            new InlineCompletionWithUpdatedRange(inlineCompletion, id, this._rangeVersionId, range)
        )
...
export class InlineCompletionWithUpdatedRange {
    get forwardStable() {
        var _a
        return (_a = this.inlineCompletion.source.inlineCompletions.enableForwardStability) !==
            null && _a !== void 0
            ? _a
            : false
    }
