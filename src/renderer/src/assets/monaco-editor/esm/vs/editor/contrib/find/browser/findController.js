...
let CommonFindController = (CommonFindController_1 = class CommonFindController extends Disposable {
            ...
            if (selectionSearchString) {
                if (this._state.isRegex) {
                    stateChanges.searchString =
                        strings.escapeRegExpCharacters(selectionSearchString)
                } else {
    ...
    async getGlobalBufferTerm() {
        if (
            this._editor.getOption(41 /* EditorOption.find */).globalFindClipboard &&
...
StartFindAction.addImplementation(0, (accessor, editor, args) => {
    ...
    return controller.start({
        ...
        seedSearchStringFromNonEmptySelection:
            editor.getOption(41 /* EditorOption.find */).seedSearchStringFromSelection ===
            'selection',
        seedSearchStringFromGlobalClipboard: editor.getOption(41 /* EditorOption.find */)
            .globalFindClipboard,
