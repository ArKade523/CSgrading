...
let SuggestController = (SuggestController_1 = class SuggestController {
    ...
    constructor(
        ...
        this.widget = this._toDispose.add(
            new WindowIdleValue(getWindow(editor.getDomNode()), () => {
                ...
                this._toDispose.add(
                    widget.onDidSelect(
                        (item) => this._insertSuggestion(item, 0 /* InsertFlags.None */),
                        this
                    )
                )
                ...
                this._toDispose.add(
                    widget.onDidFocus(({ item }) => {
                        ...
                        let value = true
                        if (
                            this.editor.getOption(1 /* EditorOption.acceptSuggestionOnEnter */) ===
                                'smart' &&
    ...
    _reportSuggestionAcceptedTelemetry(
        ...
        this._telemetryService.publicLog2('suggest.acceptedSuggestion', {
            extensionId:
                (_b = (_a = item.extensionId) === null || _a === void 0 ? void 0 : _a.value) !==
                    null && _b !== void 0
                    ? _b
                    : 'unknown',
            providerId:
                (_c = item.provider._debugDisplayName) !== null && _c !== void 0 ? _c : 'unknown',
