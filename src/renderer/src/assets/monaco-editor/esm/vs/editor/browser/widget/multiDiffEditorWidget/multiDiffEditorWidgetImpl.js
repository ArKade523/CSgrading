...
let MultiDiffEditorWidgetImpl = class MultiDiffEditorWidgetImpl extends Disposable {
    constructor(
        ...
        this._viewItems = derivedWithStore(this, (reader, store) => {
            ...
            return items.map((d) =>
                store.add(new VirtualizedViewItem(d, this._objectPool, this.scrollLeft))
            )
        })
        ...
        this.lastActiveDiffItem = derivedObservableWithCache((reader, lastValue) => {
            var _a
            return (_a = this.activeDiffItem.read(reader)) !== null && _a !== void 0
                ? _a
                : lastValue
        })
        ...
        this._register(
            autorun((reader) => {
                ...
                transaction((tx) => {
                    var _a
                    ;(_a = this._viewModel.read(reader)) === null || _a === void 0
                        ? void 0
                        : _a.activeDiffItem.set(
                              lastActiveDiffItem === null || lastActiveDiffItem === void 0
                                  ? void 0
    ...
    constructor(viewModel, _objectPool, _scrollLeft) {
            ...
            return (_c =
                (_b =
                    (_a = this._templateRef.read(reader)) === null || _a === void 0
                        ? void 0
                        : _a.object.height) === null || _b === void 0
                    ? void 0
        ...
        this.maxScroll = derived(this, (reader) => {
            ...
            return (_b =
                (_a = this._templateRef.read(reader)) === null || _a === void 0
                    ? void 0
                    : _a.object.maxScroll.read(reader)) !== null && _b !== void 0
                ? _b
                : this._lastTemplateData.read(reader).maxScroll
        })
        this.template = derived(this, (reader) => {
            var _a
            return (_a = this._templateRef.read(reader)) === null || _a === void 0
                ? void 0
                : _a.object
        })
