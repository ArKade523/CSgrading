...
let ModesHoverController = (ModesHoverController_1 = class ModesHoverController extends Disposable {
    ...
    _onEditorMouseDown(mouseEvent) {
        ...
        if (
            !((_a = this._contentWidget) === null || _a === void 0 ? void 0 : _a.widget.isResizing)
        ) {
            this._hideWidgets()
        }
    }
    ...
    _onEditorMouseMove(mouseEvent) {
        ...
        if (
            ((_a = this._contentWidget) === null || _a === void 0 ? void 0 : _a.isFocused) ||
            ((_b = this._contentWidget) === null || _b === void 0 ? void 0 : _b.isResizing)
        ) {
            return
        }
        ...
        if (
            ((_d = this._contentWidget) === null || _d === void 0 ? void 0 : _d.isVisible) &&
            this._isHoverSticky &&
            this._hidingDelay > 0
        ) {
