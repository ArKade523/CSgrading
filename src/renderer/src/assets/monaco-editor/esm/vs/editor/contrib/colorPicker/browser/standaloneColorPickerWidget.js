...
let StandaloneColorPickerController =
    (StandaloneColorPickerController_1 = class StandaloneColorPickerController extends Disposable {
        constructor(
            _editor,
            _contextKeyService,
            _modelService,
...
let StandaloneColorPickerWidget =
    (StandaloneColorPickerWidget_1 = class StandaloneColorPickerWidget extends Disposable {
        constructor(
            _editor,
            ...
            this._register(
                this._editor.onMouseMove((e) => {
                    var _a
                    const classList =
                        (_a = e.target.element) === null || _a === void 0 ? void 0 : _a.classList
        ...
        _render(colorHover, foundInEditor) {
            ...
            this._register(
                this._standaloneColorPickerParticipant.renderHoverParts(context, [colorHover])
            )
