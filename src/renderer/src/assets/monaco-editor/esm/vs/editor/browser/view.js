...
let View = class View extends ViewEventHandler {
    ...
    _computeGlyphMarginLaneCount() {
        ...
        for (const decoration of glyphs) {
            ...
            if (
                ...
                (!rightDecRange ||
                    Range.compareRangesUsingEnds(rightDecRange, decoration.range) < 0)
            ) {
                // assign only if the range of `decoration` ends after, which means it has a higher chance to overlap with the other lane
    ...
    _getEditorClassName() {
        ...
        return (
            this._context.configuration.options.get(140 /* EditorOption.editorClassName */) +
            ' ' +
    ...
    _createCoordinatedRendering() {
        return {
            ...
            renderText: () => {
                ...
                return [
                    viewPartsToRender,
                    new RenderingContext(this._context.viewLayout, viewportData, this._viewLines)
                ]
            },
    ...
    layoutContentWidget(widgetData) {
        ...
        this._contentWidgets.setWidgetPosition(
            widgetData.widget,
            (_b = (_a = widgetData.position) === null || _a === void 0 ? void 0 : _a.position) !==
                null && _b !== void 0
                ? _b
                : null,
            (_d =
